            ...
            <tr id="tr_title">
                <td style="background-color:#E9F0DE;">
                    <div class="mode_item">
                        <table>
                            <tr>
                                <td><p>題目標題:<input type="text" class="put_2" name="title_dsc" id="title_dsc"
                                                   value="<?php echo isset($dataList['title_dsc']) ? $dataList['title_dsc'] : ''; ?>">
                                    </p></td>
                            </tr>
                            <tr>
                                <td><p>題目註解:<textarea name="remark_dsc" class="tex_2"
                                                      id="remark_dsc"><?php echo isset($dataList['remark_dsc']) ? $dataList['remark_dsc'] : ''; ?></textarea>
                                    </p></td>
                            </tr>
                            <tr>
                                <td>
                                    <p>題目類型:<select name="is_practice" class="put_2" id="is_practice">
                                            <option
                                                value="1" <?php echo (isset($dataList['is_practice']) and $dataList['is_practice'] == '1') ? 'selected' : ''; ?>>
                                                練習題
                                            </option>
                                            <option
                                                value="0" <?php echo (isset($dataList['is_practice']) and $dataList['is_practice'] == '0') ? 'selected' : ''; ?>>
                                                測驗題
                                            </option>
                                        </select></p>
                                </td>
                                ...
                                <td>
                                    <p>題目圖示:<?php
                                        if (isset($dataList['img_path'])) {
                                            ?>
                                            <img
                                                src="<?php echo $base; ?>upIMG/questions/<?php echo $dataList['img_path']; ?>"
                                                width="50px">
                                            <?php
                                        }
                                        ?>
                                        <input type="file" name="img_path" class="put_2" id="img_path" value=""
                                               accept="image/*"></p>
                                </td>
                            </tr>
                            <tr>
                                <td><p>測驗起始日期:<input type="text" class="datepicker" name="begin_date" id="begin_date"
                                                     value="<?php echo isset($dataList['begin_date']) ? $dataList['begin_date'] : ''; ?>">
                                    </p></td>
                            </tr>
                            <tr>
                                <td><p>測驗結束日期:<input type="text" class="datepicker" name="end_date" id="end_date"
                                                     value="<?php echo isset($dataList['end_date']) ? $dataList['end_date'] : ''; ?>">
                                    </p></td>
                            </tr>
                            <tr>
                    ...
                    <div class="mode_item">
                        <table>
                            <tr class="title">
                                <td>模組1 閱讀出題模組</td>
                                <td>
                                    <input type="radio" name="m1" id="m1_null" value="" checked><label
                                        for="m1_null">不選用</label>
                                ...
                                <td>
                                    <input type="radio" name="m1" id="m1_<?php echo $key; ?>"
                                           value="<?php echo $tempArray['num']; ?>" <?php echo $dsc; ?>><label
                                        for="m1_<?php echo $key; ?>"><?php echo $tempArray['title_dsc']; ?></label>
                                    <?php
                                    }
                                    }
                                    ?>
                            ...
                            <tr class="title">
                                <td>模組2 搶25遊戲模組</td>
                                <td>
                                    <input type="radio" name="m2" id="m2_null" value="" checked><label
                                        for="m2_null">不選用</label>
                                ...
                                <td>
                                    <input type="radio" name="m2" id="m2_<?php echo $key; ?>"
                                           value="<?php echo $tempArray['num']; ?>" <?php echo $dsc; ?>><label
                                        for="m2_<?php echo $key; ?>"><?php echo $tempArray['title_dsc']; ?></label>
                                    <?php
                                    }
                                    }
                                    ?>
                            ...
                            <tr class="title">
                                <td>模組3 思樂冰製作遊戲模組</td>
                                <td>
                                    <input type="radio" name="m3" id="m3_null" value="" checked><label
                                        for="m3_null">不選用</label>
                                ...
                                <td>
                                    <input type="radio" name="m3" id="m3_<?php echo $key; ?>"
                                           value="<?php echo $tempArray['num']; ?>" <?php echo $dsc; ?>><label
                                        for="m3_<?php echo $key; ?>"><?php echo $tempArray['title_dsc']; ?></label>
                                    <?php
                                    }
                                    }
                                    ?>
                            ...
                            <tr class="title">
                                ...
                                <td>
                                    <input type="radio" name="m4" id="m4_null" value="" checked><label
                                        for="m4_null">不選用</label>
                                ...
                                <td>
                                    <input type="radio" name="m4" id="m4_<?php echo $key; ?>"
                                           value="<?php echo $tempArray['num']; ?>" <?php echo $dsc; ?>><label
                                        for="m4_<?php echo $key; ?>"><?php echo $tempArray['title_dsc']; ?></label>
                                    <?php
                                    }
                                    }
                                    ?>
                            ...
                            <tr class="title">
                                ...
                                <td>
                                    <input type="radio" name="m5" id="m5_null" value="" checked><label
                                        for="m5_null">不選用</label>
                                    <?php
                                ...
                                <td>
                                    <input type="radio" name="m5" id="m5_<?php echo $key; ?>"
                                           value="<?php echo $tempArray['num']; ?>" <?php echo $dsc; ?>><label
                                        for="m5_<?php echo $key; ?>"><?php echo $tempArray['title_dsc']; ?></label>
                                    <?php
                                    }
                                    }
                                    ?>
                            ...
                            <tr class="title">
                                <td>模組6 腳本互動模組</td>
                                <td>
                                    <input type="radio" name="m6" id="m6_null" value="" checked><label
                                        for="m6_null">不選用</label>
                                    <?php
                                    if (isset($modelsData['m6']) and count($modelsData['m6']) > 0){
                                    foreach ($modelsData['m6'] as $key => $tempArray){
                                    $dsc = '';
                                    if (isset($dataList['modules_dsc'][5]) and $dataList['modules_dsc'][5] == $tempArray['num']) {
                                        $dsc = 'checked';
                                    }
                                ...
                                <td>
                                    <input type="radio" name="m6" id="m6_<?php echo $key; ?>"
                                           value="<?php echo $tempArray['num']; ?>" <?php echo $dsc; ?>><label
                                        for="m6_<?php echo $key; ?>"><?php echo $tempArray['title_dsc']; ?></label>
                                    <?php
                                    }
                                    }
                                    ?>
                        ...
                        <ul id="moduleOrder">
                            ...
                            if (isset($dataList['order_dsc'])) {
                                foreach ($dataList['order_dsc'] as $value) {
                                    ?>
                                    <li>模組<?php echo $value; ?> <input type="hidden" name="module_order[]"
                                                                       value="<?php echo $value; ?>"></li>
                                    <?php
                                }
                            } else {
                                ?>
                                ...
                                <li>模組6 <input type="hidden" name="module_order[]" value="6"></li>
                                <?php
                            }
                            ?>
                        </ul>
                    ...
                    <div class="mode_item">
                        <ul>
                            ...
                            foreach ($classData as $key => $tempArray) {
                                ...
                                ?>
                                <li class="li_1"><input type="checkbox" name="swClass[]"
                                                        value="<?php echo $tempArray['num']; ?>"
                                                        id="swClass_<?php echo $key; ?>" <?php echo $dsc; ?>><label
                                        for="swClass_<?php echo $key; ?>"><?php echo $tempArray['year_dsc']; ?>
                                        年<?php echo $tempArray['class_dsc']; ?>班</label></li>
                                <?php
                            }
                            ?>
                        </ul>
                                ...
                                foreach ($dataList['analysis_words'] as $key => $value) {
                                    ...
                                    <li id="li_<?php echo $key + 1; ?>">
                                        <input type="button" value="移除"
                                               onclick="$('#li_<?php echo $key + 1; ?>').remove();">
...
<script>
    ...
    function chkSwModels() {
        ...
        if ($('input[name="m6"]:checked').length == 0) {
            err_dsc = err_dsc + '請選擇模組6 的模組!!\r\n';
        }
