            ...
            <tr id="tr_title">
                <td style="background-color:#E9F0DE;">
                    <div class="mode_item">
                        <table>
                            <tr>
                                <td><p>題目標題：<input type="text" class="put_2"
                                                   value="<?php echo isset($dataList['title_dsc']) ? $dataList['title_dsc'] : ''; ?>"
                                                   readonly/></p></td>
                            </tr>
                            <tr>
                                <td><p>題目註解：<input type="text" class="put_2"
                                                   value="<?php echo isset($dataList['remark_dsc']) ? $dataList['remark_dsc'] : ''; ?>"
                                                   readonly/></p></td>
                            </tr>
                            <tr>
                                <td>
                                    <p>題目類型：<select name="is_practice" class="put_2" id="is_practice">
                                            <option
                                                value="1" <?php echo (isset($dataList['is_practice']) and $dataList['is_practice'] == '1') ? '練習題' : ''; ?>>
                                                練習題
                                            </option>
                                            <option
                                                value="0" <?php echo (isset($dataList['is_practice']) and $dataList['is_practice'] == '0') ? '測驗題' : ''; ?>>
                                                測驗題
                                            </option>
                                        </select></p>
                                </td>
                            ...
                            <tr>
                                <td><p>測驗起始日期：<input type="text" class="put_2"
                                                     value="<?php echo isset($dataList['begin_date']) ? $dataList['begin_date'] : ''; ?>"
                                                     readonly/></p></td>
                            </tr>
                            <tr>
                                <td><p>測驗結束日期：<input type="text" class="put_2"
                                                     value="<?php echo isset($dataList['end_date']) ? $dataList['end_date'] : ''; ?>"
                                                     readonly/></p></td>
                            </tr>
                            <tr>
                                <td><span><a class="button" title="下一步驟" onclick="changeArea('tr_1')">下一步驟</a></span>
                                </td>
                            </tr>
                            </tr>
                        </table>
