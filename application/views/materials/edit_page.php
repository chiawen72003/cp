...
<div id="wrapper">
    ...
    <div class="accordionButton">
        ...
        echo form_open_multipart('materials/update_data', $attributes,$hidden);
        ?>
        ...
        <table class="list_item">
            <tr id="tr_title" >
                <td style="background-color:#E9F0DE;">
                    <div class="mode_item">
                        <table>
                            <tr>
                                <td><p>題目標題：<input type="text" class="put_1" name="title_dsc" id="title_dsc" value="<?php echo $q_data['title_dsc'];?>"></p></td>
                            </tr>
                            <tr>
                                <td>
                                    <p>可上傳檔案：<input type="checkbox" class="put_1" name="can_up_file" id="can_up_file" value="1" <?php echo ($q_data['can_up_file'] == 1)?'checked':'';?>></p>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>可填寫內容：<input type="checkbox" class="put_1" name="can_write" id="can_write" value="1" <?php echo ($q_data['can_write'] == 1)?'checked':'';?>></p>
                                </td>
                            </tr>
                            <tr>
            ...
            <tr id="tr_content" style="display:none;">
                <td style="background-color:#E4DEE9;">題目內容
                    <textarea name="contents_dsc" id="contents_dsc" ><?php echo $q_data['contents_dsc'];?></textarea>
            ...
            <tr id="tr_build_option" style="display:none;">
                <td style="background-color:#B2DDE6;">
                    <?php
                    if(count($q_data['file_data']) > 0){
                        foreach ($q_data['file_data'] as $v){
                    ?>
                        <p>原始附件：<a href="<?php echo $base.'upFILE/materials/'.$v['file_path'];?>" target="_blank"><?php echo $v['file_name'];?></a></p>
                    <?php
                        }
                    }
                    ?>
