...
<script src="<?php echo $base;?>public/js/back/jquery-1.10.1.min.js"> </script>
...
<aside>
	...
	<ul>
    	...
    	<li><a href="<?php echo site_url('memberlist/'); ?>" title="學生管理"><img src="<?php echo base_url('public/images/back/icon_add.png');?>" />學生管理</a></li>
    	<li><a href="<?php echo site_url('memck/logout'); ?>" title="登出"><img src="<?php echo base_url('public/images/back/icon_add.png');?>" />登出</a></li>
    </ul>
</aside>
<?php
	//此處插入資料
