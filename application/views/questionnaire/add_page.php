...
<script>
    ...
    function add_number_item(get_num) {
        var number_item = $('#sample_number_item').clone();
        number_item.find('#sample_number_title').attr('name', 'number_title_' + get_num + '[]').attr('id', '');
        number_item.find('#sample_number_value').attr('name', 'number_value_' + get_num + '[]').attr('id', '');
