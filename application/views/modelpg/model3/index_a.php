			...
			<div class="making_area_1">
				...
				<div>
					<table>
						<tr>
							<td >
								<div><img src="<?php echo base_url('public/images/m3_pic_sugar.png'); ?>" alt="糖" id="sugar_0" subtype="sugar" class="m3_draggable" /></div>
							</td>
							<td  >
								<div><img src="<?php echo base_url('public/images/m3_pic_salt.png'); ?>" alt="鹽" id="salt_0"  subtype="salt" class="m3_draggable"/><div>
							</td>
							<td  >
			...
			<div class="making_area_1"><!-- 思樂冰區 -->
				...
				<div><!-- 思樂材料區 -->
					<table>
						<tr>
							<td  >
								<img src="<?php echo base_url('public/images/m3_pic_salt.png'); ?>" alt="鹽" id="salt_2_1" subtype="salt" subValue="30" class="m3_draggable" />
							</td>
							<td  >
								<img src="<?php echo base_url('public/images/m3_pic_salt.png'); ?>" alt="鹽" id="salt_2_2" subtype="salt" subValue="50" class="m3_draggable" />
							</td>
							<td >
								<img src="<?php echo base_url('public/images/m3_pic_salt.png'); ?>" alt="鹽" id="salt_2_3" subtype="salt" subValue="70" class="m3_draggable"  />
							</td>
							<td   >
						...
						<tr>
							<td class="nab"><input type="text" value="30g"/></td>
							<td class="nab"><input type="text" value="50g"/></td>
							<td class="nab"><input type="text" value="70g"/></td>
...
$(function() {
	...
	$( ".m3_droppable" ).droppable({
      drop: function( event, ui ) {
		...
		if(ui.draggable.attr('subtype') == "sugar"){
			m3_left_0 = 'sugar';
			//關閉鹽巴物件拖曳功能
			$('#salt_0').draggable( 'disable' );
			...
			ui.draggable.hide();//隱藏拖曳物件
			//倒入糖的動作
			m3_run_sugar_img('m3_receiving_area',0);
...
{	
	if(m3_left_0 == 'salt' && m3_right_0 == '30'){
		var htmlDsc = '<tr><td><input type="text" value="30g鹽 + 30g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_1_A'][0])?$model_data['modelData_3']['rule_1_A'][0]:''; ?>" title="tmp" disabled />度</td></tr>';
		$('#m3_result_area').append(htmlDsc);

		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_1_A'][0])?$model_data['modelData_3']['rule_1_A'][0]:'0'; ?>;
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			...
			newScoresOBj.data = '30g鹽 + 30g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_1_A'][0])?$model_data['modelData_3']['rule_1_A'][0]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 1';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end

	}
	if(m3_left_0 == 'salt' && m3_right_0 == '60'){
		var htmlDsc = '<tr><td><input type="text" value="30g鹽 + 60g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_1_A'][1])?$model_data['modelData_3']['rule_1_A'][1]:''; ?>" title="tmp" disabled />度</td></tr>';
		
		$('#m3_result_area').append(htmlDsc);
		
		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_1_A'][1])?$model_data['modelData_3']['rule_1_A'][1]:'0'; ?>;
		$('#m3_count_tmp_1').val(countTmp);
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '30g鹽 + 60g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_1_A'][1])?$model_data['modelData_3']['rule_1_A'][1]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 1';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end
		
	}
	if(m3_left_0 == 'salt' && m3_right_0 == '90'){
		var htmlDsc = '<tr><td><input type="text" value="30g鹽 + 90g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_1_A'][2])?$model_data['modelData_3']['rule_1_A'][2]:''; ?>" title="tmp" disabled />度</td></tr>';
		
		$('#m3_result_area').append(htmlDsc);
		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_1_A'][2])?$model_data['modelData_3']['rule_1_A'][2]:'0'; ?>;
		$('#m3_count_tmp_1').val(countTmp);
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '30g鹽 + 90g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_1_A'][2])?$model_data['modelData_3']['rule_1_A'][2]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 1';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end		
	}
	if(m3_left_0 == 'sugar' && m3_right_0 == '30'){
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '30g糖 + 30g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_1_A'][3])?$model_data['modelData_3']['rule_1_A'][3]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 1';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end		
	}
	if(m3_left_0 == 'sugar' && m3_right_0 == '60'){
		var htmlDsc = '<tr><td><input type="text" value="30g糖 + 60g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_1_A'][4])?$model_data['modelData_3']['rule_1_A'][4]:''; ?>" title="tmp" disabled />度</td></tr>';
				
		$('#m3_result_area').append(htmlDsc);
		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_1_A'][4])?$model_data['modelData_3']['rule_1_A'][4]:'0'; ?>;
		$('#m3_count_tmp_1').val(countTmp);
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '30g糖 + 60g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_1_A'][4])?$model_data['modelData_3']['rule_1_A'][4]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 1';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end				
	}
	if(m3_left_0 == 'sugar' && m3_right_0 == '90'){
		var htmlDsc = '<tr><td><input type="text" value="30g糖 + 90g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_1_A'][5])?$model_data['modelData_3']['rule_1_A'][5]:''; ?>" title="tmp" disabled />度</td></tr>';
		
		$('#m3_result_area').append(htmlDsc);
		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_1_A'][5])?$model_data['modelData_3']['rule_1_A'][5]:'0'; ?>;
		$('#m3_count_tmp_1').val(countTmp);
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '<li>30g糖 + 90g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_1_A'][5])?$model_data['modelData_3']['rule_1_A'][5]:''; ?> 度</li>';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 1';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end				
...
function m3_reSet(){	
	...
	$('#salt_0').draggable('enable' ).show();
	$('#sugar_0').draggable('enable' ).show();
...
if(m3_left_0 > '' && m3_right_0 > '')
{	
	if(m3_left_0 == '30' && m3_right_0 == '150'){
		var htmlDsc = '<tr><td><input type="text" value="30g鹽 + 150g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_2_A'][0])?$model_data['modelData_3']['rule_2_A'][0]:''; ?>" title="tmp" disabled />度</td></tr>';
		$('#m3_result_area_2').append(htmlDsc);

		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_2_A'][0])?$model_data['modelData_3']['rule_2_A'][0]:'0'; ?>;
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '30g鹽 + 150g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_2_A'][0])?$model_data['modelData_3']['rule_2_A'][0]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 3';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end				
		
	}
	if(m3_left_0 == '50' && m3_right_0 == '150'){
		var htmlDsc = '<tr><td><input type="text" value="50g鹽 + 150g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_2_A'][1])?$model_data['modelData_3']['rule_2_A'][1]:''; ?>" title="tmp" disabled />度</td></tr>';
		$('#m3_result_area_2').append(htmlDsc);

		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_2_A'][1])?$model_data['modelData_3']['rule_2_A'][1]:'0'; ?>;
		$('#m3_count_tmp_2').val(countTmp);
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '50g鹽 + 150g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_2_A'][1])?$model_data['modelData_3']['rule_2_A'][1]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 3';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end				

	}
	if(m3_left_0 == '70' && m3_right_0 == '150'){
		var htmlDsc = '<tr><td><input type="text" value="70g鹽 + 150g冰塊"/></td><td>降低溫度<input type="text" class="tmp" value="<?php echo isset($model_data['modelData_3']['rule_2_A'][2])?$model_data['modelData_3']['rule_2_A'][2]:''; ?>" title="tmp" disabled />度</td></tr>';
		$('#m3_result_area_2').append(htmlDsc);

		var countTmp = m3_baseTmp - <?php echo isset($model_data['modelData_3']['rule_2_A'][2])?$model_data['modelData_3']['rule_2_A'][2]:'0'; ?>;
		$('#m3_count_tmp_2').val(countTmp);
		...
		var newScoresOBj =  $.extend(true,{}, scores_obj);
			newScoresOBj.userType = '自己';
			newScoresOBj.event = '按下按鈕';//動作類型
			newScoresOBj.data = '70g鹽 + 150g冰塊 降低溫度 <?php echo isset($model_data['modelData_3']['rule_2_A'][2])?$model_data['modelData_3']['rule_2_A'][2]:''; ?> 度';//內容值
			newScoresOBj.title = '思樂冰製作遊戲模組 3';//題目
			scores_record.push(newScoresOBj);			
		//紀錄閱卷資料 end			
	}
...
function m3_reSet_2(){
	...
	$('#salt_2_3').draggable('enable' ).show();
...
//=================================================
//倒糖動態模組
function m3_run_sugar_img(getID,getRounTime){
	var m3_delTime = 350;
	var MaxRounTime = 2;
	
	var newTop = getRounTime * 300;//top
	var cssDsc = "url('<?php echo base_url('public/images/m3_pic_3.png'); ?>') no-repeat scroll -730px -"+ newTop +"px transparent";
	
	
	if(getRounTime == MaxRounTime){
	 if(m3_right_0 > ''){
			//有冰塊
			cssDsc = "url('<?php echo base_url('public/images/m3_pic_3.png'); ?>') no-repeat scroll -300px -550px transparent";
			$('#'+getID).css('background',cssDsc);
		}else{
			cssDsc = "url('<?php echo base_url('public/images/m3_pic_3.png'); ?>') no-repeat scroll -730px -550px transparent";
			$('#'+getID).css('background',cssDsc);
		}
		...
		$('#'+getID).css('background',cssDsc);
		getRounTime++;
		setTimeout("m3_run_sugar_img('"+getID+"','"+getRounTime+"')", m3_delTime );
	}
}
