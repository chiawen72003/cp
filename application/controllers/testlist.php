            ...
            if (is_numeric($num) and is_numeric($mod)) {
                ...
                if (is_numeric($num)) {
                    ...
                    foreach ($data['model_data']['switchModel'] as $value) {
                        //閱讀出題模組
                        if ($value == '1') {
                            $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model1/index', $data,
                                true);
                        }
                        //搶25遊戲模組
                        if ($value == '2') {
                            if ($data['model_data']['userType'] == 'A') {
                                $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model2/index_a',
                                    $data, true);
                            }
                            if ($data['model_data']['userType'] == 'B') {
                                $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model2/index_b',
                                    $data, true);
                            }
                        ...
                        if ($value == '3') {
                            if ($data['model_data']['userType'] == 'A') {
                                $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model3/index_a',
                                    $data, true);
                            }
                            if ($data['model_data']['userType'] == 'B') {
                                $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model3/index_b',
                                    $data, true);
                            }
                        }
                        //最佳銷售組合模組
                        if ($value == '4') {
                            if ($data['model_data']['userType'] == 'A') {
                                $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model4/index_a',
                                    $data, true);
                            }
                            if ($data['model_data']['userType'] == 'B') {
                                $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model4/index_b',
                                    $data, true);
                            }
                        }
                        //數學渡河邏輯遊戲模組
                        if ($value == '5') {
                            $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model5/index', $data,
                                true);
                        }
                        //腳本設計模組
                        if ($value == '6') {
                            ...
                            if (isset($data['model_data']['modelData_6']['model'])) {
                                ...
                                curl_setopt($ch, CURLOPT_URL,
                                    "http://127.0.0.1/ntcu/public/Api/Model/Page/".$data['model_data']['modelData_6']['model']);
    ...
    public function recordPG()
    {
        ...
        if ($isMyRecord) {
            ...
            foreach ($data['model_data']['switchModel'] as $value) {
                ...
                if ($value == '2') {
                    if ($data['model_data']['userType'] == 'A') {
                        $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model2/index_a', $data,
                            true);
                    }
                    if ($data['model_data']['userType'] == 'B') {
                        $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model2/index_b', $data,
                            true);
                    }
                ...
                if ($value == '3') {
                    if ($data['model_data']['userType'] == 'A') {
                        $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model3/index_a', $data,
                            true);
                    }
                    if ($data['model_data']['userType'] == 'B') {
                        $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model3/index_b', $data,
                            true);
                    }
                }
                //最佳銷售組合模組
                if ($value == '4') {
                    if ($data['model_data']['userType'] == 'A') {
                        $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model4/index_a', $data,
                            true);
                    }
                    if ($data['model_data']['userType'] == 'B') {
                        $data['model_data']['switchModelData'][] = $this->load->view('modelpg/model4/index_b', $data,
                            true);
                    }
                }
                //數學渡河邏輯遊戲模組
